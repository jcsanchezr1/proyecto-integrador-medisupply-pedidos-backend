...
class OrderTopProductsController(BaseController):
    """Controlador para reporte de top productos"""
    ...
    def get(self):
        ...
        """
        try:
            report_data = self.order_service.get_top_products_report()
            
            if not report_data['top_products']:
                return self.success_response(
                    data=report_data,
            ...
            return self.success_response(
                data=report_data,
                message="Reporte de top productos generado exitosamente"
            )
