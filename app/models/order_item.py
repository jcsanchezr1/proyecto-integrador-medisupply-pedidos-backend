...
class OrderItem(BaseModel):
    ...
    def __init__(
        ...
        self.unit_price = unit_price  # TODO: Consultar del servicio de inventarios
    ...
    def _validate_product_name(self) -> None:
        """Valida el nombre del producto"""
        if not self.product_name or len(self.product_name.strip()) < 2:
            raise ValueError("El nombre del producto es obligatorio y debe tener al menos 2 caracteres")
